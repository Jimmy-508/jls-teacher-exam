...
describe('responsive styles', () => {
  ...
  it('defines gradient appearance themes for rainbow candy and aurora', () => {
    ...
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-duration:\s*7s;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-scale:\s*1\.09;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-opacity-min:\s*0\.26;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-opacity-max:\s*0\.52;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-duration:\s*9s;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-scale:\s*1\.11;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-opacity-min:\s*0\.24;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-opacity-max:\s*0\.48;/);
