...
describe('responsive styles', () => {
  ...
  it('defines gradient appearance themes for rainbow candy and aurora', () => {
    ...
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-scale:\s*1\.05;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-opacity-min:\s*0\.24;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-opacity-max:\s*0\.38;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-duration:\s*15s;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-scale:\s*1\.06;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-opacity-min:\s*0\.22;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-opacity-max:\s*0\.36;/);
    ...
    expect(themeGlow).toMatch(/inset:\s*-6%;/);
