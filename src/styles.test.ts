...
describe('responsive styles', () => {
  ...
  it('defines gradient appearance themes for rainbow candy and aurora', () => {
    ...
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-duration:\s*5\.5s;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-scale:\s*1\.14;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-opacity-min:\s*0\.28;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-opacity-max:\s*0\.68;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-duration:\s*7s;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-scale:\s*1\.16;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-opacity-min:\s*0\.26;/);
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-opacity-max:\s*0\.62;/);
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\] \.app-shell,\s*html\[data-jls-theme='aurora'\] \.app-shell\s*\{[^}]*position:\s*relative;[^}]*isolation:\s*isolate;/s);
    const specialtyShell = getCssBlock("html[data-jls-theme='rainbow-candy'] .app-shell,\nhtml[data-jls-theme='aurora'] .app-shell");
    expect(specialtyShell).not.toMatch(/animation|transform|scale|opacity:/);
    const themeGlow = getCssBlock("html[data-jls-theme='rainbow-candy'] .app-shell::before,\nhtml[data-jls-theme='aurora'] .app-shell::before");
    expect(themeGlow).toMatch(/position:\s*fixed;/);
    ...
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\] \.app-main,\s*html\[data-jls-theme='aurora'\] \.app-main\s*\{[^}]*position:\s*relative;[^}]*z-index:\s*1;/s);
    expect(getCssBlock("html[data-jls-theme='rainbow-candy'] .app-main,\nhtml[data-jls-theme='aurora'] .app-main")).not.toMatch(/animation|transform|scale|opacity:/);
    expect(getCssBlock('.bottom-nav')).toMatch(/position:\s*fixed;/);
    expect(getCssBlock('.bottom-nav')).toMatch(/bottom:\s*0;/);
    expect(getCssBlock('.bottom-nav')).not.toMatch(/animation|transform|scale|opacity:/);
