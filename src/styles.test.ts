...
describe('responsive styles', () => {
  ...
  it('defines gradient appearance themes for rainbow candy and aurora', () => {
    ...
    expect(styles).toMatch(/html\[data-jls-theme='rainbow-candy'\][\s\S]*--theme-glow-duration:\s*4\.2s;/);
    ...
    expect(styles).toMatch(/html\[data-jls-theme='aurora'\][\s\S]*--theme-glow-duration:\s*5s;/);
